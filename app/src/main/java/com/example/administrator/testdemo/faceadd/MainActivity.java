package com.example.administrator.testdemo.faceadd;
...
public class MainActivity extends AppCompatActivity {
    TextView mTextView;
    String key = "93jsfG4WVrgCN1xayGEYfobh_L7U6zA-";//api_key
    String secret = "IgNuo2RyRfoOmhT-QCPiWJJBLTa1ReEc";//api_secret
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                      ...
                      /*  Response response1 = commonOperate.detectByte(getBitmap(R.drawable.timg1), 0, null);
                   ...
                   /*     //检测第二个人脸，传的是网络图片地址
                        ...
                        String base64 = Base64.encodeToString(getBitmap(R.drawable.timg2), Base64.NO_WRAP);
